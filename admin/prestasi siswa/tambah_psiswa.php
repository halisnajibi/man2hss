...
if(isset($_POST["simpan"]) ){
    if(tambah_prestasisiswa($_POST) > 0){
          echo"
        <script>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="NAMA SISWA" aria-label="First name" id="nama" name="nama" autocomplete="off" required>
                            </div>
                        </div>
                   ...
                   <div class="row">
                            <div class="col">
                                ...
                                <input type="date" class="form-control mt-2 mb-2" placeholder="TANGGAL" aria-label="First name" id="nama" name="tanggal" autocomplete="off" required>
                            </div>
                        </div>
                          ...
                          <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="PERINGKAT" aria-label="First name" id="nama" name="peringkat" autocomplete="off" required>
                            </div>
                        </div>
                         ...
                         <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="NAMA PRESTASI" aria-label="First name" id="nama" name="nama_prestasi" autocomplete="off" required>
                            </div>
                        </div>
                          ...
                          <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="KETERANGAN" aria-label="First name" id="nama" name="keterangan" autocomplete="off" required>
                            </div>
                        </div>
