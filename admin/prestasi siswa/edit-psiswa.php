...
$id=$_GET["id"];
$t_psiswa=siswa("SELECT * FROM prestasi_siswa WHERE id=$id")[0];
?>
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <div id="collapseTwo_sekolah" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                       ...
                       <a class="collapse-item" href="../sarana prasarana/sp-view.php">Sarana & Prasana</a>
                        <a class="collapse-item" href="../jurusan/jurusan-view.php">Jurusan</a>
                        <a class="collapse-item" href="../prestasi sekolah/prestasi-view.php">Prestasi & Penghargaan</a>
                        <a class="collapse-item" href="../kepala sekolah/kepala-view.php">Kepala Sekolah</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo_siswa" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                       <a class="collapse-item" href="../ekstrakulikuler/ekstra-view.php">Ekstrakurikuler</a>
                        <a class="collapse-item" href="prestasi-view.php">Prestasi</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                          <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Update Data Prestasi Siswa</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?php echo $t_psiswa["id"] ?>">
                        <div class="row">
                            <div class="col">
                                <label for="nama">NAMA SISWA :</label>
                                <input type="text" class="form-control mt-2 mb-2" placeholder="NAMA SISWA" aria-label="First name" id="nama" name="nama" autocomplete="off" required value="<?php echo $t_psiswa["nama_siswa"] ?>">
                            </div>
                        </div>
                   ...
                   <div class="row">
                            <div class="col">
                                ...
                                <input type="date" class="form-control mt-2 mb-2" placeholder="TANGGAL" aria-label="First name" id="nama" name="tanggal" autocomplete="off" required value="<?php echo $t_psiswa["tanggal"] ?>">
                            </div>
                        </div>
                          ...
                          <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="PERINGKAT" aria-label="First name" id="nama" name="peringkat" autocomplete="off" required value="<?php echo $t_psiswa["peringkat"] ?>">
                            </div>
                        </div>
                         ...
                         <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="NAMA PRESTASI" aria-label="First name" id="nama" name="nama_prestasi" autocomplete="off" required value="<?php echo $t_psiswa["nama_prestasi"] ?>">
                            </div>
                        </div>
                          ...
                          <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="KETERANGAN" aria-label="First name" id="nama" name="keterangan" autocomplete="off" required value="<?php echo $t_psiswa["keterangan"] ?>">
                            </div>
                        </div>
