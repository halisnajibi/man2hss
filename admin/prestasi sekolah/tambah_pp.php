        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                          <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tambah Data Prestasi & Penghargaan Sekolah</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="NAMA PRESTASI" aria-label="First name" id="nama" name="nama" autocomplete="off" required>
                            </div>
                        </div>
                   ...
                   <div class="row">
                          ...
                          <div class="row">
                            <div class="col">
                                ...
                                <input type="date" class="form-control mt-2 mb-2" placeholder="TAHUN" aria-label="First name" id="nama" name="tanggal" autocomplete="off" required>
                            </div>
                        </div>
