        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                          <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tambah Data Kepala Sekolah</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="NAMA KEPALA SEKOLAH" aria-label="First name" id="nama_kepala" name="nama_kepala" autocomplete="off" required>
                            </div>
                        </div>
                   ...
                   <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="NIP" aria-label="First name" id="nama" name="nip" autocomplete="off" required>
                            </div>
                        </div>
                          ...
                          <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="TAHUN" aria-label="First name" id="nama" name="tahun" autocomplete="off" required>
                            </div>
                        </div>
                          ...
                          <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="ALAMAT" aria-label="First name" id="nama" name="alamat" autocomplete="off" required>
                            </div>
                        </div>
                         ...
                         <div class="row">
                            <div class="col">
                                ...
                                <input type="file" class="form-control mt-2 mb-2" placeholder="FOTO" aria-label="First name" id="nama" name="foto" autocomplete="off" required>
                            </div>
                        </div>
