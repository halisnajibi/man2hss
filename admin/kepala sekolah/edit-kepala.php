...
$id=$_GET["id"];
$t_sp=sp("SELECT * FROM kepala_sekolah  WHERE id=$id")[0];

if(isset($_POST["simpan"]) ){
    if(ubah_kepala($_POST) > 0){
          echo"
        <script>
                ...
                <div id="collapseTwo_siswa" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                      <a class="collapse-item" href="../ekstrakulikuler/ekstra-view.php">Ekstrakurikuler</a>
                        <a class="collapse-item" href="../prestasi siswa/prestasi-view.php">Prestasi</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                          <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Update Data Kepala Sekolah</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                 <input type="hidden" name="id" value="<?php echo $t_sp["id"] ;?>">
                                  <input type="hidden" name="fotolama" value="<?php echo $t_sp["foto"] ;?>">
                        <div class="row">
                            <div class="col">
                                <label for="nama">NAMA KEPALA SEKOLAH :</label>
                                <input type="text" class="form-control mt-2 mb-2" placeholder="NAMA KEPALA SEKOLAH" aria-label="First name" id="nama_kepala" name="nama_kepala" autocomplete="off" required value="<?php echo $t_sp["nama_kepala"]; ?>">
                            </div>
                        </div>
                   ...
                   <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="NIP" aria-label="First name" id="nama" name="nip" autocomplete="off" required value="<?php echo $t_sp["nip"];?>">
                            </div>
                        </div>
                          ...
                          <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="TAHUN" aria-label="First name" id="nama" name="tahun" autocomplete="off" required value="<?php echo $t_sp["tahun"]; ?>">
                            </div>
                        </div>
                          ...
                          <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="ALAMAT" aria-label="First name" id="nama" name="alamat" autocomplete="off" required value="<?php echo $t_sp["alamat"] ;?>">
                            </div>
                        </div>
                         ...
                         <div class="row">
                            <div class="col">
                                ...
                                <img src="foto kepala/<?php echo $t_sp["foto"]; ?>" alt="" width="100px">
                                <input type="file" class="form-control mt-2 mb-2" placeholder="FOTO" aria-label="First name" id="nama" name="foto" autocomplete="off" >
                            </div>
                        </div>
