...
$id=$_GET["id"];
$t_ekstra=sp("SELECT * FROM ekstrakurikuler WHERE id=$id")[0];
?>
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo_siswa" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                       <a class="collapse-item" href="ekstra-view.php">Ekstrakurikuler</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                          <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tambah Ekstrakurikuler</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="id" id="" value="<?php echo $t_ekstra["id"] ?>">
                        <div class="row">
                            <div class="col">
                                <label for="nama">NAMA EKSTRAKURIKULER :</label>
                                <input type="text" class="form-control mt-2 mb-2" placeholder="NAMA EKSTRAKURIKULER" aria-label="First name" id="nama_kepala" name="nama" autocomplete="off" required value="<?php echo $t_ekstra["nama"] ?>">
                            </div>
                        </div>
                   ...
                   <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="KETERANGAN" aria-label="First name" id="nama" name="keterangan" autocomplete="off" required value="<?php echo $t_ekstra["keterangan"] ?>">
                            </div>
                        </div>
