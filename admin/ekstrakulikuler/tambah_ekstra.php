                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="NAMA EKSTRAKURIKULER" aria-label="First name" id="nama_kepala" name="nama" autocomplete="off" required>
                            </div>
                        </div>
