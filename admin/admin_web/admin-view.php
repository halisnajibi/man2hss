                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="row">
                                <div class="col">
                                <?php foreach ($t_admin as $data_g) ?>
                                       <a class="btn btn-primary" href="edit_admin.php?id_admin=<?php echo $data_g["id_admin"] ?>">Update Data</a>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $data_g["username"] ?>
                                    </td>
                                    <td>
                                        <?php echo $data_g["password_admin"] ?>
                                    </td>
                                    <td>
                                        <?php echo $data_g["email"] ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <img src="img/<?php echo $data_g["foto"] ?>" alt="foto admin" width="100px">
                                    </td>
