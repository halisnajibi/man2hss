...
$t_guru=guru("SELECT * FROM guru");


if(isset($_POST["tombol_cari_gr"]) ){
    $t_guru=cari_guru($_POST["keyword_gr"]);
}
                    ...
                    <div class="card-header py-3">
                            <div class="row">
                                <div class="col">
                                       ...
                                       <a class="cetak btn btn-success" href="cetak_guru.php">Cetak Data</a>
                                </div>
                                <div class="form col">
                            ...
                            <div class="table-responsive">
                                <table  id="example" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="foto guru/<?php echo $data_g["foto"] ;?> " alt=""  width="50">
                                     </td>
                                        <td>
                                            <a href="edit_guru.php?id_guru=<?php echo $data_g["id_guru"]; ?> "><i class="fas fa-pen-square data-bs-placement="top" title="Edit""></i></a>
                                            <a href="hapus_guru.php?id_guru=<?php echo $data_g["id_guru"] ;?>" onclick="return confirm ('anda yakin ingin menghapus data?')"><i class="fas fa-trash data-bs-placement="top" title="Hapus"""></i></a>
                                        </td>
                                    </tr>
                                    </tbody>
                                    <?php $i++; ?>
