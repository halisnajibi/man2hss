                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control mt-2 mb-4" placeholder="NAMA" aria-label="First name" id="nama_siswa" name="nama" autocomplete="off" required>
                                 </div>
                                <div class="col">
                                    <label for="nis">NIP :</label>
                                    <input type="text" class="form-control mt-2 mb-4" placeholder="NIP" aria-label="First name" id="nis" name="nip" autocomplete="off" maxlength="18"    required>
                                </div>
                            </div>
