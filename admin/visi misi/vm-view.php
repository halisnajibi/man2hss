                ...
                <div id="collapseTwo_sekolah" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                       <a class="collapse-item" href="../sejarah/sejarah-view.php">Sejarah</a>
                        <a class="collapse-item" href="vm-view.php">Visi & Misi</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                          <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tabel Visi Misi</h1>
                            ...
                            <div class="table-responsive">
                                ...
                                <tr>
                                    <td>
                                     ...
                                     <td>
                                         <?php echo $data_g["misi"] ?>
                                    </td>
                                     <td>
                                         <?php echo $data_g["visi"] ?>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                                <?php endforeach; ?>
