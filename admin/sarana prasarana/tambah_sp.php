                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="NAMA BARANGA" aria-label="First name" id="nama" name="nama_barang" autocomplete="off" required>
                            </div>
                        </div>
                   ...
                   <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="JUMLAH" aria-label="First name" id="nama" name="jumlah" autocomplete="off" required>
                            </div>
                        </div>
