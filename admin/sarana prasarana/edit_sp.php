...
$id=$_GET["id"];
$t_sp=sp("SELECT * FROM sarana_prasarana WHERE id=$id")[0];
?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                          <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tambah Data Sarana & Prasarana</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                  <input type="hidden" name="id_sp" value="<?php echo $t_sp["id"] ;?>">
                        <div class="row">
                            <div class="col">
                                <label for="nama">NAMA BARANG :</label>
                                <input type="text" class="form-control mt-2 mb-2" placeholder="NAMA BARANGA" aria-label="First name" id="nama" name="nama_barang" autocomplete="off" required value="<?php echo $t_sp["nama_barang"]; ?>">
                            </div>
                        </div>
                   ...
                   <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-2" placeholder="JUMLAH" aria-label="First name" id="nama" name="jumlah" autocomplete="off" required value="<?php echo $t_sp["jumlah"] ;?>" >
                            </div>
                        </div>
