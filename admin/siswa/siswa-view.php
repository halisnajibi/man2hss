...
$t_siswa=siswa("SELECT * FROM  siswa ORDER BY id_siswa DESC");
$t_admin=admin( "SELECT*FROM admin");

if(isset($_POST["tombol_cari"]) ){
    $t_siswa=cari_siswa($_POST["keyword"]);
}
?>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="siswa-view.php">Data Siswa</a>
                        ...
                        <div class="card-header py-3">
                            <div class="row">
                                <div class="col">
                                       ...
                                       <a class="cetak btn btn-success" href="cetak_siswa.php">Cetak Data</a>
                                </div>
                                <div class="form col">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" type="submit"  name="tombol_cari" >
                            ...
                            <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $data_g["jurusan"] ?>
                                        </td>
                                        <td>
                                            <?php echo $data_g["tahun_masuk"] ?>
                                        </td>
                                        <td>
                                            <?php echo $data_g["jenis_kelamin"] ?>
                                        </td>
                                        <td>
                                            <?php echo $data_g["tanggal_lahir"] ?>
                                        </td>
                                        <td>
                                            <?php echo $data_g["tempat_lahir"] ?>
                                        </td>
                                        <td>
                                            <?php echo $data_g["alamat"] ?>
                                        </td>
                                        <td>
                                            <?php echo $data_g["telepon"] ?>
                                        </td>
                                        <td>
                                            <img src="foto siswa/<?php echo $data_g['foto']; ?> " alt=""  width="50">
                                        </td>
                                        <td>
                                            <a href="edit_siswa.php?id_siswa=<?php echo $data_g["id_siswa"]; ?> "><i class="fas fa-pen-square data-bs-placement="top" title="Edit""></i></a>
                                            <a href="hapus_siswa.php?id_siswa=<?php echo $data_g["id_siswa"] ;?>" onclick="return confirm ('anda yakin ingin menghapus data?')"><i class="fas fa-trash data-bs-placement="top" title="Hapus"""></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                    <?php endforeach; ?>
