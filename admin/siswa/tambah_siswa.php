...
$t_siswa=siswa("SELECT * FROM siswa");
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Pages Collapse Menu -->
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        ...
                        <a   a class="collapse-item" href="../siswa/siswa-view.php">Data Siswa</a>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control mt-2 mb-4" placeholder="NIS" aria-label="First name" id="nis" name="nis" autocomplete="off" maxlength="4"    required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control mt-2 mb-4"  aria-label="First name" id="tgl" name="tahun_masuk" autocomplete="off"  placeholder="TAHUN MASUK"  required>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <input type="date" class="form-control mt-2 mb-4"  aria-label="First name" id="tl" name="tanggal_lahir" autocomplete="off" placeholder="ALAMAT"    required>
                                </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control mt-2 mb-4"  aria-label="First name" id="tl" name="tempat_lahir" autocomplete="off" placeholder="TEMPAT LAHIR" maxlength="12"   required>
                            </div>
                            <div class="col">
                                <label for="tl">ALAMAT :</label>
                                <input type="text" name="alamat" class="form-control mt-2 mb-4"  placeholder="ALAMAT"   aria-label="First name">
                            </div>
                         </div>
                         ...
                         <div class="row">
                            <div class="col-6">
                                ...
                                <input type="file" class="form-control mt-2 mb-4"  aria-label="First name" id="tl" name="foto" autocomplete="off" placeholder="TELEPON" maxlength="12"   required>
                            </div>
                         ...
                         <div class="row mt-4">
                                <div class="col d-grid gap-2">
                                    <div class="d-grid gap-2 d-md-block">
                                        ...
                                        <button class="btn btn-danger" type="reset">Isi Ulang</button>
                                    </div>
                                </div>
                         </div>
                         </form>
