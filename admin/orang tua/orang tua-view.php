...
$t_org=orangtua("SELECT * FROM orang_tua,siswa  WHERE orang_tua.id_siswa=siswa.id_siswa ");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                          <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tabel Orang Tua Siswa</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="row">
                                <div class="col">
                                       <a class="btn btn-primary" href="tambah_org.php">Tambah Data</a>
                                       <a class="cetak btn btn-success" href="cetak_org.php">Cetak Data</a>
                                </div>
                                <div class="form col">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $data_g["nama_siswa"] ?> <?php echo $data_g["nis"] ?>
                                    </td>
                                    <td>
                                        <?php echo $data_g["nama_ayah"] ?>
                                    </td>
                                    <td>
                                        <?php echo $data_g["nama_ibu"] ?>
                                    </td>
                                    <td>
                                        <?php echo $data_g["pekerjaan_ayah"] ?>
                                    </td>
                                    <td>
                                        <?php echo $data_g["pekerjaan_ibu"] ?>
                                    </td>
                                    <td>
                                        <?php echo $data_g["alamat_ayah"] ?>
                                    </td>
                                    <td>
                                        <?php echo $data_g["alamat_ibu"] ?>
                                    </td>
                                    <td>
                                    <img src="foto orang tua/<?php echo $data_g["foto_ayah"] ?>" alt="" width="50">  
                                    </td>
                                    
                                    <td>
                                    <img src="foto orang tua/<?php echo $data_g["foto_ibu"] ?>" alt="" width="50">  
                                    </td>
                                    <td>
                                    <a href="edit_org.php?id_orgtua=<?php echo $data_g["id_orgtua"]; ?> "><i class="fas fa-pen-square data-bs-placement="top" title="Edit""></i></a>
                                    <a href="hapus_org.php?id_orgtua=<?php echo $data_g["id_orgtua"] ;?>" onclick="return confirm ('anda yakin ingin menghapus data?')"><i class="fas fa-trash data-bs-placement="top" title="Hapus"""></i></a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                                <?php endforeach; ?>
